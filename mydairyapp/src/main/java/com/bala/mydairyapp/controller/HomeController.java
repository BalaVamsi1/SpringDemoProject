package com.bala.mydairyapp.controller;
...
import com.bala.mydairyapp.service.EntryService;
import com.bala.mydairyapp.service.UserService;
...
public class HomeController {
	...
	public String homepage() {
		String model=new String("loginform");
		return model;
	}
	
	@GetMapping("register")
	public String registrationpage() {
		String model=new String("registrationform");
		return model;
	}
	...
	public String updateentry(@RequestParam("id") int id,Model model) {
		String viewname="displayentryupdate";
		Entry entry=entryService.findById(id);
		model.addAttribute("entry",entry);
		//missed code
		User user1=(User) session.getAttribute("user");
